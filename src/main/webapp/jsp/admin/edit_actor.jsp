...
<html>
<head>
    <title><fmt:message key="label.edit_actor"/></title>
...
<div class="main-content">
    <div class="edit-picture">
        <form action="${pageContext.request.contextPath}/UploadServlet" method="post"
            ...
            <input type="hidden" name="command" value="change_actor_picture">
            <input type="hidden" name="actor_id" value="${requestScope.actor.actorId}">
            <input type="hidden" name="picture_path" value="${requestScope.actor.picture}">
            <div class="left">
        ...
        <div class="input-space">
            <form action="${pageContext.request.contextPath}/controller" method="post">
                ...
                <c:choose>
                    ...
                    <c:when test="${requestScope.actor.height != 0}">
                        <input type="text" id="height" name="height" value="${requestScope.actor.height}"
                               required>
                    </c:when>
                </c:choose>
                ...
                <c:choose>
                    ...
                    <c:when test="${requestScope.actor.birthDate != null}">
                        <input type="text" id="birth-date" name="birth_date"
                               placeholder="<fmt:message key="label.date_example"/>"
                               required
                               value="${requestScope.actor.birthDate}">
                    </c:when>
                </c:choose>
