...
public class DisplayMovieCountriesCommand implements Command {

    private static final Logger logger = LogManager.getLogger(DisplayMovieCountriesCommand.class);
