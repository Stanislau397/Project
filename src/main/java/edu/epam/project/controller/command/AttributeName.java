...
public class AttributeName {
    ...
    public static final String LOW_SCORE_MOVIE_TITLE = "low_score_title";
    public static final String HIGH_SCORE_MOVIE_TITLE = "high_score_title";
    public static final String LOW_MOVIE_ID = "low_movie_id";
    ...
    public static final String DIRECTORS_LIST = "directors_list";
